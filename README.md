...
<p align="center">
  ...
  <img alt="DeepSeek Harness" src="https://img.shields.io/badge/DSH%200.1.5--rc.1%20%2F%20rc.2%20%2F%200.1.6--alpha.2-blue">
...
> **兼容性**：v0.5.2 支持 DSH **0.1.5-rc.1+**，已在 **0.1.5-rc.1 / 0.1.5-rc.2 / 0.1.6-alpha.2 / 0.1.7-rc.1** 实测（`alpha4-probe` + real-cordis 探针 277/277 通过，实测 0.1.7-rc.1 依赖集）。设置子系统已迁移至 0.1.7 的 `SettingsForms`（插件 Config schema + volatile 热更 + 自建设置页）。旧版 DSH（0.1.0-rc.6 及更早）请使用最后兼容的 npm 版本 **0.4.0**。
