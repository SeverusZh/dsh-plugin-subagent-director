...
> **兼容性**：v0.5.0 支持 DSH **0.1.5-rc.1+**，已在 **0.1.5-rc.1 / 0.1.5-rc.2 / 0.1.6-alpha.2** 实测（`alpha4-probe` + real-cordis 探针 278/278 通过，实测 0.1.5-rc.1/0.1.5-rc.2/0.1.6-alpha.2 依赖集）。旧版 DSH（0.1.0-rc.6 及更早）请使用最后兼容的 npm 版本 **0.4.0**。
